...
def registerPage(request):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            messages.error(request,"Error in registering user, please check the field values")
...
def userProfile(request,pk):
    ...
    rooms = user.room_set.all()  #fetch rooms of particular user.
...
def activityPage(request):
    ...
    return render(request,'studybud/activity.html',{'room_messages':room_messages})